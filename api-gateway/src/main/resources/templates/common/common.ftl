                        ...
                        <div class="col-md-3 col-sm-3">
                            <article>
                                ...
                                <ul class="list-unstyled list-links">
                                    ...
                                    <li><a href="/templates/blog/list">博客</a></li>
                                </ul>
                            </article>
                        </div>
                    </div><!-- /.row -->
...
<aside id="edit-search">
    ...
    <form role="form" id="_searchForm" class="form-search" method="post" action="/templates/house/list">
            ...
            <header class="navbar" id="top" role="banner">
                ...
                <nav class="collapse navbar-collapse bs-navbar-collapse navbar-right" role="navigation">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="has-child"><a href="/templates/house/list">房产</a>
                            <ul class="child-navigation">
                                <li><a href="/templates/house/list?type=1">售房</a></li>
                                <li><a href="/templates/house/list?type=2">租房</a></li>
                            </ul>
                        </li>
                        ...
                        <li><a href="/templates/blog/list">百科</a></li>
                    </ul>
                </nav><!-- /.navbar collapse-->
                <div class="add-your-property">
                    <a href="/templates/house/toAdd" class="btn btn-default"><i class="fa fa-plus"></i><span class="text">添加房产</span></a>
                </div>
            </header><!-- /.navbar -->
        </div><!-- /.container -->
    </div>
